    ...
    <v-container>
      ...
      <v-row>
        <v-col>
          ...
          <br />
          <p>
            Si te apasiona el maravilloso mundo de la lectura estás en el lugar indicado, en la Biblioteca Comunitaria encontrarás una gran variedad de generos literarios, asi que busca tu libro preferido, prestalo y a leer...
          </p>
        </v-col>
      </v-row>
